...
define('calculator/lib/calculations/AddNumberToken',['exports', 'calculator/constant/TokenManagerStates'], function (exports, _TokenManagerStates) {
    ...
    exports.default = function (tokenManager, button) {
        ...
        tokenManager.push(button.mathSymbol, {
            replace: tokenManager.answerStr === "0" || tokenManager.state === _TokenManagerStates2.default.EVALUATED
        });
    };
});
...
define('calculator/math',['exports', 'mathjs', 'calculator/utils'], function (exports, _mathjs, _utils) {
    'use strict';
    ...
    function evaluateTokens(tokens) {
        ...
        var chain = _mathjs2.default.chain(tokens.slice(0, nextOperatorIndex === -1 ? tokens.length : nextOperatorIndex).join(''));
    ...
    var EventApi = function () {
        ...
        _createClass(EventApi, [{
            ...
            value: function trigger(eventName) {
                ...
                this._events[eventName].forEach(function (eventObj) {
...
;
define('calculator/lib/managers/TokenManager',['exports', 'calculator/math', 'calculator/constant/TokenManagerStates', 'calculator/constant/TokenManagerEvents', 'calculator/lib/event/EventApi'], function (exports, _math, _TokenManagerStates, _TokenManagerEvents, _EventApi) {
    'use strict';
    ...
    var _class = function () {
        ...
        _createClass(_class, [{
            ...
            value: function change(funct, context) {
                this._eventApi.on(_TokenManagerEvents2.default.CHANGE, funct, context);
            }
        }, {
            key: 'evaluation',
            value: function evaluation(funct, context) {
                this._eventApi.on(_TokenManagerEvents2.default.EVALUATION, funct, context);
            }
        }, {
            key: 'trigger',
            value: function trigger(eventName) {
        ...
        Object.defineProperties(this, {
            "expressionStr": {
                get: function get() {
                    ...
                    return toString(_this.tokens.slice(0, lastOperatorIndex + 1));
                }
            },
            "answerStr": {
                get: function get() {
                    var lastOperatorIndex = getLastOperatorIndex.call(_this);
                    return toString(_this.tokens.slice(lastOperatorIndex + 1));
                }
            }
        });
    }
